...
<body>
  <div class="container">
    <header class="bg-primary">
      ...
      <div class="nav-right">
        <a href="../My profile/my_profile.php"><svg xmlns="http://www.w3.org/2000/svg" class="account transition" viewBox="0 0 512 512">
            ...
            <div class="input-card add-exam-name">
              <form action="addExam.php" method="POST" name="newExam" enctype=”multipart/form-data”>
                ...
                <div class="input-card-content flex flex-col items-center">
                  <input type="text" id="add-exam-name" placeholder="Enter the Exam Name" name="exam-name" />
                  <label for="add-exam-name">Assign the exam name(to be shown to students)</label>
                </div>
                <div class="input-card-content flex flex-col items-center">
                  <input type="number" id="add-exam-name" placeholder="Enter the Exam Duration" name="exam-duration" />
                  ...
                  <ul>
                    <li class="info-item">
                      <svg xmlns="http://www.w3.org/2000/svg" class="info-icon" viewBox="0 0 512 512">
                        ...
                        <path fill="none" stroke="orange" stroke-linecap="round" stroke-linejoin="round" stroke-width="32" d="M352 176L217.6 336 160 272" />
                        <rect x="64" y="64" width="384" height="384" rx="48" ry="48" fill="none" stroke="orange" stroke-linejoin="round" stroke-width="32" />
                      </svg>
